...
map_layout = [
    [' ', 'B', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S'],
    ['S', 'B', ' ', ' ', 'S', 'S', ' ', ' ', 'B', 'S', ' ', ' ', ' ', 'B', 'B', 'B', ' ', 'S', ' ', 'B', 'B', 'B', ' ', 'S', ' ', ' '],
    ['S', 'S', 'S', ' ', ' ', 'S', 'B', 'S', 'B', 'S', 'B', 'S', 'B', 'S', 'S', 'S', 'B', 'S', 'B', 'S', 'S', 'S', 'B', 'S', 'S', 'B'],
    ['S', 'B', 'S', 'S', 'B', 'S', ' ', 'S', 'B', 'B', 'B', 'S', 'B', 'S', 'B', 'S', ' ', 'B', ' ', 'S', ' ', 'S', 'B', 'B', 'B', ' '],
    ['S', ' ', 'B', ' ', 'B', 'S', 'B', 'S', 'S', 'S', 'S', 'S', 'B', 'S', 'B', 'S', 'S', 'S', 'S', 'S', 'B', 'S', 'S', 'S', 'S', 'S'],
    ['S', ' ', 'B', 'S', 'B', 'S', 'B', ' ', 'B', 'S', 'B', 'B', 'B', 'S', 'B', ' ', ' ', ' ', ' ', 'S', ' ', ' ', 'B', 'S', 'B', 'S'],
    ['S', 'S', 'B', 'S', 'B', 'S', 'S', 'S', 'B', 'S', 'B', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'B', 'S', 'B', 'S', 'B', 'B', 'B', 'S'],
    ['S', ' ', ' ', 'S', ' ', 'B', 'B', ' ', 'B', 'S', 'B', 'S', ' ', 'B', ' ', ' ', ' ', 'S', ' ', 'S', 'B', 'S', 'S', 'S', 'B', 'S'],
    ['S', 'B', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'B', 'S', 'B', 'S', 'B', 'S', ' ', ' ', 'B', 'S', 'B', 'B', 'B', 'S', 'B', 'S'],
    ['S', 'B', 'B', 'B', 'B', 'B', 'B', 'S', ' ', 'S', 'B', 'B', ' ', 'S', 'B', 'S', 'S', 'S', 'B', 'S', ' ', 'S', 'S', 'S', 'S', 'S'],
    ['S', 'B', 'B', 'S', 'B', 'S', 'B', 'S', 'B', 'S', 'S', 'S', 'S', 'S', ' ', 'S', 'B', 'S', 'B', 'S', 'B', 'S', 'B', 'S', ' ', 'S'],
    ['S', 'B', 'S', 'S', 'B', 'S', 'B', 'S', 'B', 'B', 'B', 'B', ' ', 'B', ' ', 'S', 'B', ' ', 'B', 'S', ' ', 'B', 'B', 'S', 'B', 'S'],
    ['S', 'B', 'B', 'S', 'B', 'S', 'B', 'S', ' ', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'B', 'S', 'S', 'S', 'S', ' ', 'B', 'B', 'B', 'S'],
    ['S', 'S', 'B', 'S', 'S', 'S', 'B', 'S', ' ', 'B', 'B', ' ', 'B', 'B', ' ', 'S', ' ', ' ', 'S', 'B', 'B', 'B', 'S', 'B', 'S', 'S'],
    ['S', ' ', 'B', ' ', 'B', 'S', 'B', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'B', 'S', 'B', 'B', 'S', ' ', 'S', ' ', 'S', ' ', 'B', 'S'],
    ['S', 'S', 'S', 'S', ' ', 'S', ' ', 'S', ' ', 'B', 'B', 'B', 'B', 'S', ' ', 'S', 'S', ' ', 'S', 'B', 'S', 'B', 'S', 'S', 'B', 'S'],
    ['S', ' ', ' ', 'B', 'B', 'S', 'S', 'S', 'B', 'S', 'S', 'S', ' ', 'S', ' ', 'S', 'B', 'B', 'S', 'B', 'S', ' ', 'B', 'B', 'S', 'S'],
    ['S', 'B', 'S', 'B', ' ', 'B', ' ', 'S', ' ', 'S', ' ', 'S', ' ', 'S', 'B', 'S', ' ', 'S', 'S', 'B', 'S', 'S', 'S', 'B', 'S', 'S'],
    ['S', 'B', 'S', 'S', 'S', 'B', 'B', 'B', 'B', ' ', 'B', 'S', 'B', ' ', 'B', 'S', ' ', ' ', ' ', ' ', 'B', ' ', 'S', 'B', ' ', 'S'],
    ['S', ' ', 'S', 'B', 'S', 'S', ' ', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'B', 'S', 'S', 'S', 'S', 'S', 'B', 'S', 'S', 'S', 'S', 'S'],
    ['S', 'B', 'S', 'B', 'S', 'B', ' ', ' ', 'S', 'B', ' ', 'B', 'B', 'S', 'B', ' ', ' ', 'S', ' ', 'S', 'B', 'S', 'B', 'B', 'B', 'S'],
    ['S', 'G', 'S', 'B', 'S', 'S', 'S', 'S', 'S', 'B', 'S', 'S', 'S', 'S', 'B', 'S', ' ', 'S', 'B', 'S', 'B', 'S', ' ', 'S', ' ', 'S'],
    ['S', 'B', 'S', 'B', ' ', 'B', ' ', ' ', ' ', 'B', 'B', 'B', 'B', 'B', 'B', 'S', 'B', 'B', 'B', 'S', 'B', 'B', 'B', 'S', 'E5', 'S'],
...
def game_over():
    """Display 'MISSION COMPLETED!' message, developer credits, and an ending animation."""
    
    # Initialize pygame
    pygame.init()

    # Set up screen (if not set globally)
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    ...
    # Create text objects
    text = font.render("CONGRATULATIONS SOLDIER!", True, (255, 0, 0))
    credit_text = credit_font.render("Developed by:", True, (255, 255, 255))
    devs_text = credit_font.render("Buen David Nichols & Carlo Mercado Rufo", True, (255, 255, 255))

    # Fade effect settings
    alpha = 255  # Starting alpha value for the text (opaque)
    fade_speed = 5  # Speed of the fade effect (higher value = faster fade)

    # Display the text and credits initially
    screen.fill((0, 0, 0))  # Fill screen with black
    screen.blit(text, (SCREEN_WIDTH // 2 - text.get_width() // 2, SCREEN_HEIGHT // 2 - text.get_height() // 2))
    screen.blit(credit_text, (SCREEN_WIDTH // 2 - credit_text.get_width() // 2, SCREEN_HEIGHT // 2 + 100))
    screen.blit(devs_text, (SCREEN_WIDTH // 2 - devs_text.get_width() // 2, SCREEN_HEIGHT // 2 + 160))

    pygame.display.flip()  # Update display

    # Animation loop: fade out the text
    ...
    while waiting_for_click:
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                waiting_for_click = False  # Exit loop when clicked

        # Fade the text by reducing the alpha value
        if alpha > 0:
            alpha -= fade_speed
            text.set_alpha(alpha)
            credit_text.set_alpha(alpha)
            devs_text.set_alpha(alpha)

        # Redraw the screen and texts
        screen.fill((0, 0, 0))  # Fill screen with black
        screen.blit(text, (SCREEN_WIDTH // 2 - text.get_width() // 2, SCREEN_HEIGHT // 2 - text.get_height() // 2))
        screen.blit(credit_text, (SCREEN_WIDTH // 2 - credit_text.get_width() // 2, SCREEN_HEIGHT // 2 + 100))
        screen.blit(devs_text, (SCREEN_WIDTH // 2 - devs_text.get_width() // 2, SCREEN_HEIGHT // 2 + 160))
        ...
        pygame.display.flip()  # Update display
        time.sleep(0.05)  # Add a slight delay to control the fade speed

    pygame.quit()  # Quit the game after the fade-out is done
